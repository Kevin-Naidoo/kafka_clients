defmodule KafkaProducer do
  ...
  def charge_payload2 do
    payload = ["binary data","0.0","NULL","911302350","{\"balances\": [\"uncapped\"], \"service_type\": \"mobile_data\"}","20240122--7e4f6812-b972-11ee-8d87-6cae8b6312a2","Unlimited home 5G Premium","{\"{\\\"qty\\\": 911302350, \\\"amount\\\": 0, \\\"balance_name\\\": \\\"uncapped\\\"}\"}","0","0.0","20240122--7e4ef724-b972-11ee-a6ee-6cae8b6312a2","NULL","2024-01-22 23:55:56+02","1","{\"ratType\": \"NR\", \"ipv4_addr\": \"10.209.0.59\", \"requestor\": \"satest\", \"chargingId\": 375455463, \"service_id\": \"msisdn-27816699304\", \"resource_id\": \"imei-861935050829590\", \"oneTimeEvent\": false, \"userLocationinfo\": {\"nrLocation\": {\"tai\": {\"nid\": null, \"tac\": \"07F394\", \"plmnId\": {\"mcc\": \"655\", \"mnc\": \"73\"}}, \"ncgi\": {\"nid\": null, \"plmnId\": {\"mcc\": \"655\", \"mnc\": \"73\"}, \"nrCellId\": \"0d1414033\"}, \"ignoreNcgi\": null, \"globalGnbId\": null, \"geodeticInformation\": null, \"ueLocationTimestamp\": \"2024-01-20T18:01:52+02:00\", \"geographicalInformation\": null, \"ageOfLocationInformation\": null}, \"n3gaLocation\": null, \"eutraLocation\": null}}","0","5G Home X","911302350","6000","vfs_udg_upf_01","NULL","{\"mode\": \"ONLINE\", \"sessionFailover\": \"FAILOVER_NOT_SUPPORTED\"}","1.110000","2024-01-22 12:06:29+02","400","imsi-655730000598400","5G Home X","{\"gl\": \"9500A030\", \"name\": \"VAT\", \"fixed\": 0, \"percentage\": 15, \"tax_amount\": 0.0, \"taxable_amount\": 0, \"tax_inclusive_amount\": 0.0}","2024-01-23 00:06:29+02","{\"model\": \"POST-PAID\", \"unit_info\": {\"triggers\": [{\"triggerType\": \"QUOTA_THRESHOLD\", \"triggerCategory\": \"IMMEDIATE_REPORT\"}, {\"triggerType\": \"QUOTA_EXHAUSTED\", \"triggerCategory\": \"IMMEDIATE_REPORT\"}, {\"triggerType\": \"QHT\", \"triggerCategory\": \"IMMEDIATE_REPORT\"}, {\"triggerType\": \"VALIDITY_TIME\", \"triggerCategory\": \"IMMEDIATE_REPORT\"}], \"validityTime\": 43200, \"quotaHoldingTime\": 0, \"timeQuotaThreshold\": 70, \"unitQuotaThreshold\": 80}, \"final_unit\": {\"finalUnitAction\": \"TERMINATE\"}, \"quota_calc\": \"default\", \"quota_rules\": [], \"neg_balances\": false, \"default_quota\": {\"name\": \"totalVolume\", \"quota\": 57982058496}, \"policy_states\": [\"High Speed\", \"RICA\", \"Device\", \"Payment\", \"PAYMENT_HOLD\"], \"vqt_percentage\": 0.4}","100","{\"time\": null, \"triggers\": [{\"timeLimit\": null, \"triggerType\": \"VALIDITY_TIME\", \"volumeLimit\": null, \"volumeLimit64\": null, \"maxNumberOfccc\": null, \"triggerCategory\": \"IMMEDIATE_REPORT\"}], \"totalVolume\": 911302350, \"uplinkVolume\": 192325086, \"downlinkVolume\": 718977264, \"eventTimeStamp\": null, \"triggerTimestamp\": \"2024-01-23T00:06:29+02:00\", \"serviceSpecificUnits\": null}","0","NULL","2024-01-23 00:06:43+02","2024-01-23 00:06:43+02","a72e5f19-6245-4d24-8f69-3bf4bf215895"]
  ...
  def async_cast_process_charge(iterations) do
    1..iterations
    |> Enum.each(fn _ ->
      Task.async(fn -> process_charge(charge_payload()) end)
    end)
  end
  ...
  defp produce_record(row) do
    ...
    Task.async(fn -> process_charge(json_row) end)
  end
end
